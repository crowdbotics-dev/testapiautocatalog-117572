...
## Project Structure
    ...
    ├── testapiautocatalog_117572  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_117572`
...
2. Clone this repo and `cd testapiautocatalog_117572`
